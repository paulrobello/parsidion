...
> **New in 0.25.0:** Configurable summarizer doctor timeout (600 seconds by default), safer launchd environment handling, and vault-health/doctor reliability fixes. See the [Changelog](CHANGELOG.md).
...
Latest release: **0.25.0** (configurable summarizer doctor timeout, safer launchd environment handling, and vault-health/doctor reliability fixes). See [CHANGELOG.md](CHANGELOG.md) for a detailed list of changes in each release.
