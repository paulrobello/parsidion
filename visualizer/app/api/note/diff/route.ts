...
export const GET = withApi(async (req: NextRequest) => {
  ...
  // The earlier `if (!stem && !notePathParam)` check logically guarantees stem
  // is set when notePathParam is absent, but TypeScript cannot narrow across
  // the ternary — so spell the invariant out and return 400 on regression.
